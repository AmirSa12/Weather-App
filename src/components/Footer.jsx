  ...
  return (
    <footer className="footer items-center p-4 bg-neutral text-neutral-content">
        <div className="items-center grid-flow-col">
            ...
            <p>Copyright © {footerDate} - All right reserved by AmirSa12</p>
        </div> 
        <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
            <a href='https://github.com/AmirSa12' target='_blank' rel='noreferrer'><FaGithub className='w-8 h-8'/></a> 
            <a href='https://instagram.com/amirhossein.sa12' target='_blank' rel='noreferrer'><SiDiscord className='w-8 h-8'/></a>
            <a href='https://instagram.com/amirhossein.sa12' target='_blank' rel='noreferrer'><AiFillInstagram className='w-8 h-8'/></a>
        </div>
    </footer>
  )
}
